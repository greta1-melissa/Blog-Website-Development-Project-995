      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-purple-100">
          ...
          <div className="w-full bg-purple-100 rounded-full h-2 mb-6">
            <div className="bg-gradient-to-r from-purple-500 to-pink-500 h-2 rounded-full w-0 transition-all duration-300" id="reading-progress"></div>
          </div>
        </div>
        ...
        >
          ...
          <p className="text-purple-100 leading-relaxed">
            Hi! I'm Melissa, a mom who loves sharing authentic stories about family life, wellness, and my passion for K-culture. 
            Thank you for reading and being part of this amazing community! 💜
          </p>
        ...
        >
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-purple-100">
            ...
            <Link
              to="/"
              className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              <SafeIcon icon={FiArrowLeft} className="mr-2" />
              Back to All Posts
            </Link>
