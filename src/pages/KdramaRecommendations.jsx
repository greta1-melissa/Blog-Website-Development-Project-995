...
const { FiArrowLeft, FiTv, FiStar, FiHeart, FiFilm, FiImage } = FiIcons;
  ...
  const moreFavorites = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1518181282240-721245c38981?w=800&auto=format&fit=crop&q=60',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1620400030248-cb8c87c06eb6?w=800&auto=format&fit=crop&q=60',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1514539079130-25950c84af65?w=800&auto=format&fit=crop&q=60',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1503756234508-e32369269deb?w=800&auto=format&fit=crop&q=60',
        ...
        <div className="grid grid-cols-1 gap-12">
          {currentFavorites.map((drama) => (
            <div 
              id={drama.id} 
              key={drama.id}
              className="bg-white rounded-2xl shadow-sm border border-purple-50 overflow-hidden scroll-mt-24 hover:shadow-lg transition-shadow duration-300"
            >
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/3 min-h-[250px] relative bg-purple-100">
                  ...
                  {/* Overlay for small text readability if needed, though mostly image */}
                  <div className="absolute inset-0 bg-gradient-to-r from-black/10 to-transparent md:bg-gradient-to-l md:from-black/10 md:to-transparent opacity-0 md:opacity-10" />
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {moreFavorites.map((drama) => (
            <div 
              id={drama.id} 
              key={drama.id}
              className="bg-white rounded-2xl shadow-sm border border-purple-50 overflow-hidden hover:shadow-xl transition-all duration-300 scroll-mt-24 flex flex-col"
            >
              <div className="h-56 relative bg-purple-100">
                {drama.image ? (
                  <img 
                    src={drama.image} 
                    alt={drama.title} 
                ...
                <h3 className="absolute bottom-4 left-4 right-4 text-2xl font-bold text-white shadow-sm">
                  {drama.title}
                </h3>
              </div>
