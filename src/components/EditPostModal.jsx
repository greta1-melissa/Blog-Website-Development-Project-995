...
const EditPostModal = ({ isOpen, onClose, post, onSave, categories }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (cleanImage.includes('dropbox.com') && !cleanImage.includes('raw=1')) {
      setErrorMessage("Dropbox images require '?raw=1' at the end of the URL to display correctly.");
      return;
    }
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="relative">
                        ...
                        <label
                          ...
                          className={`flex items-center justify-center w-full px-4 py-2 border border-dashed rounded-lg cursor-pointer transition-colors whitespace-nowrap text-sm bg-white ${uploadStatus.includes('Failed') ? 'border-red-300 text-red-600' : 'border-purple-300 text-purple-600 hover:bg-purple-50'}`}
                        >
                          {isUploading ? (
