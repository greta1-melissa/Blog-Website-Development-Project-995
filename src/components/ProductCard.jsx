...
const { FiStar, FiExternalLink, FiHeart } = FiIcons;
      ...
      <Link to={`/post/${product.id}`}>
        <div className="relative overflow-hidden aspect-square md:aspect-auto">
          ...
          <div className="absolute top-4 left-4">
            <span className="bg-white/90 backdrop-blur-md text-purple-800 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm">
              {subcategory}
            </span>
          </div>
        </div>
